...
class FstMap:
    DIRECTIVES = ['PRESENT', 'PAST', 'PASSIVE', 'NOUNSUFFIX', 'NOUNPREFIX', 'POSSESSIVE', 'VERB2NOUN', 'VERBSUFFIX','VERBY',
                  'VERBPREFIXPRESENT','VERBPREFIXPAST', 'NOUNPLURAL', 'ADJPLURAL', 'ADJPREFIX','ADVSUFFIX']
