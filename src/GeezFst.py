...
class GeezFst:
    ...
    def ccc_verbs(self):
        ...
        fsts["PRE"]["N"]["WE"] = self.variable["e_na"]
        fsts["PAS"]["N"]["WE"] = FST.re("$2e_i @ $e_na", self.variable)
        ...
        fsts["PRE"]["ME"]["WE"] = FST.re("$e_na  ", self.variable)
        fsts["PAS"]["ME"]["WE"] = FST.re("$2e_i @ $e_na  ", self.variable)
        ...
        fsts["PRE"]["HIM"]["WE"] = FST.re("$e_na @ $_yo", self.variable)
        fsts["PAS"]["HIM"]["WE"] = FST.re("$2e_i @ $e_na @ $_yo", self.variable)
        ...
        fsts["PRE"]["HER"]["WE"] = FST.re("$e_na @ $_ya", self.variable)
        fsts["PAS"]["HER"]["WE"] = FST.re("$2e_i @   $e_na @ $_ya", self.variable)
        ...
        fsts["PAS"]["HER"]["YOU_SF"] = FST.re("$2e_i @ $e_k @ $_ya", self.variable)
        ...
        fsts["PAS"]["US"]["HE"] = FST.re("$2e_i @ $e_na", self.variable)
        fsts["PRE"]["US"]["SHE"] = FST.re("$_tna", self.variable)
        fsts["PAS"]["US"]["SHE"] = FST.re("$2e_i @ $6e_a @ $_tna", self.variable)
